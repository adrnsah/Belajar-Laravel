...
<body>
    ...
    <div class="container">
        ...
        <div class="row mt-5">
            <div class="col"></div>
            <div class="col"></div>
            <div class="col-2"> <a class="btn btn-success" href="{{ route('admin.tambahBerita') }}"
        ...
        <table class="table" style="margin-top: 10px">
            ...
            <tbody class="table-group-divider"> @foreach ($data as $index => $berita) <tr>
                    <td scope="row">{{ $index + $data->firstItem() }}</td>
                    <td>{{ $berita->judul }}</td>
                    <td>{{ $berita->tanggal }}</td>
                    <td>
                        <img style="width: 50px" src="{{ asset('/images/' . $berita->gambar) }}" alt="berita">
                    </td>
                    <td>{{ $berita->konten }}</td>
                    <td> <a class="btn btn-outline-warning" href="/admin/editBerita/{{ $berita->id }}">Edit</a>
